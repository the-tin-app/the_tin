# Contributing to The Tin

Thanks for your interest! The Tin is a community-funded hobby project,
maintained in spare time, for the love of the game.

## What helps most

- **Card data corrections** (wrong connected-art layouts, card ordering,
  set data) — open an issue with a source (card images, official set lists).
- **Bug reports** with steps to reproduce.
- **Small, focused pull requests.** Please open an issue before starting
  anything large so we can agree on the approach first.
