...
The Tin is free, has no ads, no premium tier, and no scan limits — and it costs real money to
run. Graded prices and population data come from a paid commercial API; the card catalog and the
scanner's recognition pack are served to every device that installs the app; the App Store
developer account renews every year.
...
*$10 / month. Covers the daily price rebuild and the recognition pack every install downloads.*

<!-- No sponsors at this tier yet. -->

## Holo

*$5 / month. The tier that keeps The Tin free.*

<!-- No sponsors at this tier yet. -->

## Common

*$3 / month. Every collection is built on them.*
...
- **Names are added by hand**, usually within a week of a sponsorship starting. If yours is
  missing after that, [open an issue](https://github.com/the-tin-app/the_tin/issues) and it'll
  get fixed.
...
Running costs, in rough order of size:

| What | Why it costs |
|---|---|
| Graded price + population API | Commercial data licence — the single largest line |
| Catalog and scanner pack serving | Bandwidth for the nightly catalog and the recognition pack |
